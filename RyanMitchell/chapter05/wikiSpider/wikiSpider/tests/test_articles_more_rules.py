...
class TestArticlesMoreRules(TestCase):
    ...
    def setUp(self):
        self.spider = ArticlesSpider3(name=SPIDER_NAME)
        ArticlesSpider3.BROWSE = self.BROWSE
        ArticlesSpider3.HTML_EXT = self.HTML_EXT
